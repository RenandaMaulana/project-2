...
<body>
            ...
            <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
                <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                    ...
                    <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1">
                        Edit User UMKM Alun-Alun Subang
                    </h4>
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Edit informasi User</p>
                                    <form>
                                        @csrf
                                        <div class="form-group">
                                            <label for="exampleInputName1">ID</label>
                                            <label name="name" type="text" class="form-control"
                                                id="exampleInputName1">{{ auth()->user()->id }}</label>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">Nama</label>
                                            <label name="name" type="text" class="form-control"
                                                id="exampleInputName1">{{ auth()->user()->name }}</label>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail3">Email</label>
                                            <label name="email" type="email" class="form-control"
                                                id="exampleInputEmail3">{{ auth()->user()->email }}</label>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail3">Password</label>
                                            <label name="password" type="text" class="form-control"
                                                id="exampleInputEmail3">{{ auth()->user()->password }}</label>
                                        </div>
    ...
    <!-- container-scroller -->
    @if (session()->has('toats_success'))
        <script>
            swal.fire((
                text: "{{ session('toats_success') }}",
                icon: "success"
            ));
        </script>
    @endif
