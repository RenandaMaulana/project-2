                            ...
                            "
                              ...
                              "
                                    ...
                                    "
                                      ...
                                      "
                                                                        align="left">
                                                                        Kami melihat bahwa Anda mengalami kesulitan
                                                                        masuk ke akun Anda. Jangan khawatir, kami di
                                                                        sini untuk membantu Anda mendapatkan akses
                                                                        kembal, Silakan klik
                                                                        tautan di bawah ini untuk Reset Password
                                                                        Anda.
                                                                    </p>
                                                                    <table class="s-4 w-full" role="presentation"
                                      ...
                                      ">
                                            ...
                                            "
                                                                                    ...
                                                                                    <a href="{{ config('app.url') }}/forgotpassword/forgot-password-email/forgot-input-password"
                                                                                        style="
                                                                                        {{-- <a href="{{ config('app.url') }}/{{ $url }}/{{ $user->id }}/{{ $user->email_verification->token }}/{{ $user->email_verification->method }}"
                                                                                        style=" --}} color:
                                                                                        #ffffff; font-size: 16px;
                                                                                        font-family: Helvetica, Arial,
                                                                                        sans-serif; text-decoration:
                                                                                        none; border-radius: 6px;
                                                                                        line-height: 20px; display:
