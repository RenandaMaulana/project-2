...
<head>
    ...
    <title>verifikasi Akun</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
                                    <div class="text">
                                        <h3>Terima kasih! Kami telah mengirimkan email verifikasi password ke Email yang
                                            Anda masukan</h3>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: center;">
                                    <div class="text-author">
                                        <img src="https://assets.bootstrapemail.com/logos/light/square.png"
                                            alt=""
                                            style="width: 100px; max-width: 600px; height: auto; margin: auto; display: block;">
                                        <h3 class="name">Alun-Alun Subang</h3>
                                        <span class="position">periksa Email Anda untuk melanjutkan verifikasi
                                            Akun Anda</span>
