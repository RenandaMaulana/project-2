                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Tambah User</p>
                                    <form action="{{ route('Admin-daftar-user') }}" method='POST'>
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputName1">masukan Password kembali</label>
                                            <input name="password_validasi" type="password" class="form-control"
                                                id="exampleInputName1" placeholder="input Password kembali" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">role</label>
                                            <select name="role" id="role" class="form-control">
                                                <option value="admin">admin</option>
                                                <option value="user">kepala_dinas</option>
                                        ...
                                        <a href="{{ route('kelola-user') }}"class="btn btn-light">Cancel</a>
                                    </form>
                                </div>
                            </div>
                        </div>
