                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Tambah Event</p>
                                    <form action="{{ route('admin-pengajuanevent') }}" method='POST'>
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="event" type="text" class="form-control"
                                                id="exampleInputName1" placeholder="event" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">No Handphone</label>
                                            <input name="phone" type="number" class="form-control"
                                                id="exampleInputName1" placeholder="No Handphone" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">Target Peserta</label>
                                            <select name="target_peserta" id="role" class="form-control">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputName1">Berkas</label>
                                            <input name="berkas" type="file" class="form-control" required
                                                accept=".pdf" id="exampleInputName1" placeholder="berkas" />
                                            <p style="color: red;">format file <span
                                                    style="font-weight: bold;">.pdf</span></p>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">Tanggal Acara</label>
                                            <input name="tanggalacara" type="date" class="form-control"
                                                id="exampleInputName1" placeholder="Tanggal Acara" />
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">Selesai Acara</label>
                                            <input name="selesaiacara" type="date" class="form-control"
                                                id="exampleInputName1" placeholder="Selesai Acara" />
                                        </div>
